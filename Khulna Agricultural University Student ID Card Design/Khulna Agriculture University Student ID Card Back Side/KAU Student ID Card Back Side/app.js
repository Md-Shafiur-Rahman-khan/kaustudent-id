...
btnPreview.addEventListener('click', () => {
    ...
    && inputfields["Date of Expire"].value != ""
...
function toggle(){
         ...
         <p style="text-transform: uppercase; font-weight: bold; font-family: Georgia, 'Times New Roman', Times, serif;">:  ${inputfields["Date of Expire"].value} </p>
...
function toggle1(){
            output1.innerHTML=`
          <p style="color: black; text-align: center; font-weight: bold;">${inputfields["schoolname"].value}</p>`
